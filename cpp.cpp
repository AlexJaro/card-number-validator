...
if(length==13){std::cout<<" Thus, your card is Visa. ";
return 0;}
if(length==14){std::cout<<" Thus, your card is Diners Club and Carte Blanche. ";
return 0;}
if(length==15)
	{
	...
	return 0;}
	else{std::cout<<"Your card is JCB. ";
	return 0;}
	}
if(length==16)
{
if(first_four=="6011"){std::cout<<"Your card is Discover. ";
return 0;}
	if(first=="4"){std::cout<<"Thus, your card is Visa. ";
	return 0;}
	if(first=="3"){std::cout<<"Thus, your card is JCB. ";
	return 0;}
	else{std::cout<<"Your card is MasterCard. ";
	return 0;}
}
}
